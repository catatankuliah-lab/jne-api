...
router.get(
  ...
  authMiddleware.authorizeRole([1, 3, 7, 8, 9, 10, 13]),
...
router.get(
  "/driver/availability",
  authMiddleware.authenticate,
  authMiddleware.authorizeRole([1, 3, 7, 9]),
...
router.get(
  "/driver/:id_driver",
  authMiddleware.authenticate,
  authMiddleware.authorizeRole([1, 3, 7, 9, 10]),
...
router.put(
  ...
  authMiddleware.authenticate,
  authMiddleware.authorizeRole([1, 3, 2, 3, 9, 10]),
