...
router.get(
  ...
  authMiddleware.authorizeRole([1, 2, 3, 9, 12]), // Adjust roles that are allowed
...
router.post(
  "/armada",
  authMiddleware.authenticate,
  authMiddleware.authorizeRole([1, 2, 3, 9, 12]), // Adjust the roles that are allowed to add data
...
router.put(
  "/armada/:id_armada",
  authMiddleware.authenticate,
  authMiddleware.authorizeRole([1, 2, 3, 9, 12]), // Adjust roles that are allowed to update data
...
router.delete(
  "/armada/:id_armada",
  authMiddleware.authenticate,
  authMiddleware.authorizeRole([1, 2, 3, 9, 12]), // Adjust roles that are allowed to delete data
